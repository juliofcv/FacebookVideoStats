...
import edu.artec.apps.facebook.Config;
...
public class FacebookPageUtils {
    ...
    public FacebookPageUtils(String fbPageUser, String token) throws Exception {
        fbPageUser = fbPageUser.replace("https://www.facebook.com/", "");

        org.json.simple.JSONObject json1 = readJSon(graphUrl+fbPageUser+"?access_token="+token);
        org.json.simple.JSONObject json2 = readJSon(graphUrl+fbPageUser+"?fields=fan_count&access_token="+token);
